...
> **Implementation status — v0.2–v0.3 (2026-07-17).** The shipped build deliberately diverges from parts of this spec; where they conflict, the following **supersedes** the text below:
