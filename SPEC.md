...
> **Implementation status — v0.2–v0.6 (2026-07-18).** The shipped build deliberately diverges from parts of this spec; where they conflict, the following **supersedes** the text below:
